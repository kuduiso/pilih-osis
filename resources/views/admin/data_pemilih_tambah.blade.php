...
<h3 class="text-blue-500 text-4xl font-medium">Form Pemilih</h3>
    ...
    <div class="card">
        ...
        <div class="flex flex-row mt-2">
            <div class="mx-2 flex-grow">
                ...
                <input type="text" class="form-input mt-1 w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" name="nama_pemilih" id="nama_pemilih" value="{{ old('nama_pemilih') }}" placeholder="Masukkan nama"  oninvalid="this.setCustomValidity('Wajib diisi')" oninput="this.setCustomValidity('')" required>
                @error('nama_pemilih')
                    <span class="text-xs text-red-600">*{{ $message }}</span>
                @enderror
            </div>
        ...
        <div class="flex flex-row mt-2">
            <div class="mx-2 flex-grow">
                ...
                <input type="text" class="form-input mt-1 w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" name="kelas_pemilih" id="kelas_pemilih" value="{{ old('kelas_pemilih') }}" placeholder="Masukkan kelas"  oninvalid="this.setCustomValidity('Wajib diisi')" oninput="this.setCustomValidity('')" required>
                @error('kelas_pemilih')
                    <span class="text-xs text-red-600">*{{ $message }}</span>
                @enderror
            </div>
        ...
        <div class="flex flex-row mt-2">
            <div class="mx-2 flex-grow">
                ...
                <input type="radio" id="laki" name="jk_pemilih" value="l" {!! old('jk_pemilih') === 'l' ? 'checked' : '' !!}>
                <label for="laki">Laki-Laki</label><br>
                <input type="radio" id="perempuan" name="jk_pemilih" value="p" {!! old('jk_pemilih') === 'p' ? 'checked' : '' !!} required>
