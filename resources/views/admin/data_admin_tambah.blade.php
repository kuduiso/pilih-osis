...
<h3 class="text-blue-500 text-4xl font-medium">Tambah Admin</h3>
...
<form action="{{ action('AdminController@add_admin') }}" method="POST" class=" flex justify-center">
    @csrf
    <div class="card flex-col max-w-md">
        ...
        <button class="mt-4 w-full bg-green-500 hover:bg-green-600 focus:ring-2 focus:ring-green-100 px-3 py-2 text-white rounded-md" type="submit">Tambah</button>
    </div>
</form>
@endsection
