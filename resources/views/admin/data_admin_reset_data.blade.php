...
<h3 class="text-blue-500 text-4xl font-medium">Reset Data</h3>
...
<div class="mt-4 text-center">
    <p class="text-xl mb-2">Klik tombol di bawah untuk melakukan reset data:</p>
    <form action="{{ action('AdminController@reset_data') }}" id="reset_data" method="POST" class="flex w-full">
        @csrf
        <button type="button" onclick="on_reset()" class="bg-red-500 hover:bg-red-600 focus:ring-2 ring-red-300 focus:bg-red-600 p-3 font-bold text-white text-xl rounded-md w-full">Reset Data</button>
    </form>
</div>
